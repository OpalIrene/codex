...
st.markdown(
    ...
    **How to view the Market Overview:**
    ...
    <div style="margin-left:12px; user-select:none; -webkit-user-select:none; -moz-user-select:none;">Use the sidebar Search coins box to filter by coin name or symbol.</div>

    <div style="margin-left:12px;">The Market Overview table on the left updates to show matching coins.</div>

    <div style="margin-left:12px;">Selecting a coin displays its persistent price chart and metrics on the left.</div>
    """,
    unsafe_allow_html=True,
)
